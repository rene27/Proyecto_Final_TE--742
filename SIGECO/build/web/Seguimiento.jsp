...
<html>
    ...
    <body>
        ...
        <p><a href="SeguimientoControlador?action=add" class="btn"><img src="2.png" title="Nuevo registro"/>NUEVO</a></p>
            ...
            <div class="tbl-content">
                ...
                <c:forEach var="item" items="${hoj}">        
                    <tr>
                        ...
                        <td><a  href="SeguimientoControlador?action=edit&id=${item.id_seguimiento}" onclick="return(confirm('ESTA SEGURO DE EDITAR EL DATO DE CARGO DE   ??'))" class="btn1"><img src="4.png" width="18" title="Modificar"/></a></td>
                        <td><a  href="SeguimientoControlador?action=delete&id=${item.id_seguimiento}" onclick="return(confirm('ESTA SEGURO DE ELIMINAR EL DATOS DE CARGO DE ??'))" class="btn2"><img src="3.png" width="18" title="Eliminar"/></a></td>
                    </tr>
                </c:forEach>
               </tbody>
    </table>
