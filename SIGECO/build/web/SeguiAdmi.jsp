            ...
            <div class="tbl-content">
                ...
                <c:forEach var="item" items="${hoj}">        
                    <tr>
                        ...
                        <td><a  href="ControladorSeguiadmi?action=edit&id=${item.id_seguimiento}" onclick="return(confirm('ESTA SEGURO DE EDITAR EL DATO DE CARGO DE   ??'))" class="btn1"><img src="4.png" width="18" title="Modificar"/></a></td>
                     </tr>
                </c:forEach>
               </tbody>
    </table>
