...
<html lang="es">
    ...
    <body>        
        <c:if test="${objeto.id_tipo == 0}">
            <h1 align="center">REGISTRAR DATOS DEL DOCUMENTO</h1>
        </c:if>
        <c:if test="${objeto.id_tipo != 0}">
                <h1 align="center">MODIFICAR DATOS DEL DOCUMENTO  "${objeto.nombre_doc}"  </h1>
        </c:if>
            <form action="TipoDocControlador" method="post">
                <h3 align="center">
                <c:if test="${objeto.id_tipo == 0}">
                ...
                <input type="hidden" name="id_tipo" value="${objeto.id_tipo}"/>
            <table>
                <tr>
                    <td>NOMBRE DOCUMENTO:</td>
                    <td><input type="text" name="nombre_doc" value="${objeto.nombre_doc}" required=""></td>
                </tr>
                <tr>
                    <td></td>
