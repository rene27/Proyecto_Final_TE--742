 ...
 * @author Usuario
 */
@WebServlet(name = "SeguimientoControlador", urlPatterns = {"/SeguimientoControlador"})
@MultipartConfig(
        ...
        try {
            ...
            switch (action) {
                ...
                case "delete":
                    id = Integer.parseInt(request.getParameter("id"));
                    dao.delete(id);
                    response.sendRedirect(request.getContextPath() + "/SeguimientoControlador");
                    break;
                ...
                case "view":
                    ...
                    List<Seguimiento> hoj = dao.getAll();
